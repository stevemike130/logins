...
const yourCon = document.getElementById('yourCon');
const yourCon2 = document.getElementById('yourCon2');
...
const conInvoice = document.getElementById('con-div');
...
const emailImg2 = document.getElementById('email-img2')
const emailVerify = document.getElementById('email-verify');
const emailVerify2 = document.getElementById('email-verify2');
...
const yesPhone = document.getElementById('yes-phone');
...
auth.onAuthStateChanged(user => {
	...
	if(user.email && user.phoneNumber) {
		if (user.displayName && user.email) {
			...
			if(user.email.includes('yahoo.com')){
				...
				emailImg2.src = 'img/partners/yahoo.png';
				vpnImg.src = 'img/partners/yahoo.png';
			} else {
				emailImg.src = 'img/partners/google.png';
				emailImg2.src = 'img/partners/google.png';
			...
			emailImg2.src = 'img/partners/emails.png';
			vpnImg.src = 'img/partners/emails.png';
		} 

		yesPhone.style.display = 'block';
		emailVerify.addEventListener('click', sendEmail);
		emailVerify2.addEventListener('click', sendEmail);
		jinaHolder.readOnly = true;
		jinaHolder3.readOnly = true;
		jinaHolder2.innerText = 'User ID: ' + user.uid;
		conInvoice.style.display = 'flex';
		yourCon.innerText = user.email;
		yourCon2.innerText = user.phoneNumber;
	...
	if(user.isAnonymous && localStorage.getItem('cx-time')) {
		cxA.innerHTML = 'Get Phone Invoice';
		cxDiv.setAttribute('data-bs-target', '#phoneModal');
		cxImg.src = 'img/partners/phone.png';
	} else if(user.isAnonymous && !localStorage.getItem('cx-time')) {
		cxA.innerHTML = 'Buy Anonymously';
		cxDiv.setAttribute('data-bs-target', '#vpnModal');
		cxImg.src = 'img/partners/anonymous.png';

		cxA.addEventListener('click', sendNotification);
		function sendNotification() {
			var shortCutFunction = 'success';
			var msg = `
				Anonymous checkout is risky if you don't have strong internet.
				<hr class="to-hr">
				Create a burner email and use it to get an email invoice.
				<hr class="to-hrh">
				It's optional if you prefer to remain fully anonymous.
			`;
			toastr.options = {
				closeButton: true,
				debug: false,
